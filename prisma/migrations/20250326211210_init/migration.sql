...
-- CreateEnum
CREATE TYPE "statusOccurrence" AS ENUM ('REGISTRADO', 'ATENDENDO', 'FINALIZADO');
...
CREATE TABLE "Occurrence" (
    ...
    "statusOccurrence" "statusOccurrence" NOT NULL DEFAULT 'REGISTRADO',
